    ...
    return (
        <div class="drawer drawer-end" data-theme={theme}>
            ...
            <div class="drawer-content flex flex-col">
                {/* <!-- Navbar --> */}
                <div class="w-full navbar shadow-xl fixed top-0 z-50 bg-base-100 px-10 lg:px-10">
                    <div class="flex-1 px-2 mx-2">
                        {
                            pathname.includes('dashboard') && <label for="my-drawer-2" class="btn btn-glass drawer-button lg:hidden">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16M4 18h7" /></svg>
                            </label>
                        }
                        <span className="text-xl font-bold sm:ml-2"> Cell Mart</span>
                    </div>
