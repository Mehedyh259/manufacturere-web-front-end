...
const Navbar = ({ children }) => {
    ...
    const menuItems = <>
        ...
        <label className="swap swap-rotate lg:ml-3">
            ...
            <input onClick={() => handleTheme(theme)} type="checkbox" />
    ...
    return (
        <div className="drawer drawer-end" data-theme={theme}>
            ...
            <div className="drawer-content flex flex-col">
                {/* <!-- Navbar --> */}
                <div className="w-full navbar shadow-xl fixed top-0 z-50 bg-base-100 px-5 lg:px-10">
                    <div className="flex-1 px-2 mx-2">
                        {
                            pathname.includes('dashboard') && <label htmlFor="my-drawer-2" className="btn btn-ghost drawer-button lg:hidden">
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 6h16M4 12h16M4 18h7" /></svg>
                            </label>
                        }
                        <span className="text-xl font-bold sm:ml-3"> Cell Mart</span>
                    </div>
